...
namespace Blog_final_Asp.Areas.Administration.Controllers
{
    public class PostsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,Body,Date_posted,Date_modified,Picture")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,Body,Date_posted,Date_modified,Picture")] Post post)
        {
            if (ModelState.IsValid)
            {
